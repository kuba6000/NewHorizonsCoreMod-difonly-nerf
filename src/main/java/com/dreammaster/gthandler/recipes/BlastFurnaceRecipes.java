...
public class BlastFurnaceRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.RedstoneAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.RedstoneAlloy, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.RedstoneAlloy, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.RedstoneAlloy, 1L))
                .duration(1 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1200)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.ConductiveIron, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.ConductiveIron, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.ConductiveIron, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.ConductiveIron, 1L))
                .duration(2 * MINUTES).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1500).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.EnergeticAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.EnergeticAlloy, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.EnergeticAlloy, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.EnergeticAlloy, 1L))
                .duration(2 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 2500)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.EnergeticSilver, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.EnergeticSilver, 1L))
                .fluidInputs(Materials.Hydrogen.getGas(1000L)).duration(1 * MINUTES + 20 * SECONDS)
                .eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 2200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.EnergeticSilver, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.EnergeticSilver, 1L))
                .duration(2 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 2500)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VibrantAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.VibrantAlloy, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VibrantAlloy, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.VibrantAlloy, 1L))
                .duration(5 * MINUTES).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 3600).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VividAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.VividAlloy, 1L))
                .fluidInputs(Materials.Hydrogen.getGas(1000L)).duration(2 * MINUTES + 30 * SECONDS)
                .eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 3000).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VividAlloy, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.VividAlloy, 1L))
                .duration(5 * MINUTES).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 3600).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.CrystallineAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.CrystallineAlloy, 1L))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.CrystallinePinkSlime, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.MelodicAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.MelodicAlloy, 1L))
                .duration(2 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 5400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.StellarAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.StellarAlloy, 1L))
                .duration(3 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(COIL_HEAT, 7200)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.ElectricalSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.ElectricalSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1000).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.ElectricalSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.ElectricalSteel, 1L))
                .duration(2 * MINUTES).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.PulsatingIron, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.PulsatingIron, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.PulsatingIron, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.PulsatingIron, 1L))
                .duration(2 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 2200)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Soularium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Soularium, 1L))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1000).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.DarkSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.DarkSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(50 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1800).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.DarkSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.DarkSteel, 1L))
                .duration(1 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 2200)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.EndSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.EndSteel, 1L))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 4500).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.EnderiumBase, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.EnderiumBase, 1L))
                .duration(2 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 3300)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Enderium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Enderium, 1L))
                .duration(2 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 4500)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Reinforced, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Reinforced, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1700).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Reinforced, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Reinforced, 1L))
                .duration(1 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1700)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Galgadorian, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Galgadorian, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Galgadorian, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Galgadorian, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Draconium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Draconium, 1L))
                .duration(3 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(COIL_HEAT, 7200)
                .metadata(ADDITIVE_AMOUNT, 1000).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.DraconiumAwakened, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.DraconiumAwakened, 1L))
                .duration(4 * MINUTES + 10 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 9900)
                .metadata(ADDITIVE_AMOUNT, 1000).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Cobalt, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Ardite, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Ardite, 1L)).circuit(1)
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Ardite, 1L)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1600).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Manyullyn, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Manyullyn, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Manyullyn, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Manyullyn, 1L))
                .duration(2 * MINUTES).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 3600).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Desh, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Desh, 1L)).circuit(1)
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Desh, 1L))
                .duration(2 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 2500)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.ElectrumFlux, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.ElectrumFlux, 1L))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 9000).metadata(ADDITIVE_AMOUNT, 1000)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.FierySteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.FierySteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(50 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1600).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.FierySteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.FierySteel, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Sunnarium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Sunnarium, 1L))
                .duration(1 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 4500)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.HSSG, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.HSSE, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.HSSS, 1L)).circuit(11)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadah, 1L))
                .duration(30 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 5000).metadata(ADDITIVE_AMOUNT, 1000)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahAlloy, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahAlloy, 1L))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_ZPM / 2).metadata(COIL_HEAT, 7200)
                .metadata(ADDITIVE_AMOUNT, 1000).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahEnriched, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahEnriched, 1L))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 5350).metadata(ADDITIVE_AMOUNT, 1000)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Naquadria, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadria, 1L))
                .duration(30 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 9000).metadata(ADDITIVE_AMOUNT, 1000)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Trinium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Trinium, 1L))
                .duration(70 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(COIL_HEAT, 7200).metadata(ADDITIVE_AMOUNT, 1000)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Osmium, 1L)).circuit(11)
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmium, 1L)).duration(50 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Iridium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Iridium, 1L))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 4500).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Oriharukon, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Oriharukon, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 5400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Vyroxeres, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Vyroxeres, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 5400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Alduorite, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Alduorite, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 6600)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Mithril, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Mithril, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(COIL_HEAT, 6600)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Ceruclase, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Ceruclase, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(COIL_HEAT, 6600)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Vulcanite, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Vulcanite, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 8400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.ShadowIron, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.ShadowIron, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 8400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Chrysotile, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Chrysotile, 1L))
                .duration(1 * MINUTES + 55 * SECONDS).eut(TierEU.RECIPE_UV).metadata(COIL_HEAT, 9400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Tartarite, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Tartarite, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.BlackPlutonium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.BlackPlutonium, 1L))
                .duration(5 * MINUTES).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 9000).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VanadiumSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.VanadiumSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1453).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VanadiumSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.VanadiumSteel, 1L))
                .duration(1 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1453)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.DamascusSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.DamascusSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1500).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.DamascusSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.DamascusSteel, 1L))
                .duration(1 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1500)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.BlackSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(50 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.BlackSteel, 1L))
                .duration(1 * MINUTES + 10 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1200)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.RedSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.RedSteel, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.RedSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.RedSteel, 1L))
                .duration(1 * MINUTES + 15 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1300)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.BlueSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.BlueSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1400).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.BlueSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.BlueSteel, 1L))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Aluminium, 4L)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 963).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 1L))
                .circuit(11)
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Aluminium, 1L))
                .fluidInputs(Materials.Nitrogen.getGas(1000L)).duration(90 * SECONDS).eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .circuit(1)
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Aluminium, 1L))
                .duration(2 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 2054)
                .addTo(blastFurnaceRecipes);
        // NEEDED TO MOVE FROM GREG, CODE WAS TOO LONG

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Osmiridium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmiridium, 1L))
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(10000, 10000).duration(1500 * SECONDS).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 2000)
                .addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.WroughtIron, 50L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 50L), Materials.Ash.getDust(1))
                .fluidInputs(Materials.Oxygen.getGas(10000)).outputChances(10000, 10000).duration(750 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.MeteoricIron, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.MeteoricSteel, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(25 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.GalliumArsenide, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.GalliumArsenide, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.GalliumArsenide, 2L))
                .circuit(2).itemOutputs(ItemList.GalliumArsenideCrystal.get(1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(45 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1511).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Ilmenite, 10L),
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium, 2L))
                .circuit(12)
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titanium, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Magnesiumchloride, 4L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1L)).circuit(11)
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.AnnealedCopper, 1L))
                .fluidInputs(Materials.Oxygen.getGas(1000L)).duration(25 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Titanium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titanium, 1L))
                .duration(1 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 1940)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Tungsten, 1L))
                .duration(8 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 3000)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Tantalum, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Tantalum, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.TungstenSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L))
                .duration(2 * MINUTES + 5 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 4000)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.TungstenCarbide, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L))
                .duration(1 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 2460)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.VanadiumGallium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L))
                .duration(3 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 4500)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.NiobiumTitanium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L))
                .duration(3 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 4500)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Nichrome, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 2700).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.StainlessSteel, 1L))
                .circuit(1).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L))
                .duration(1 * MINUTES + 25 * SECONDS).eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 1700)
                .addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.StainlessSteel, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.DeepIron, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.DeepIron, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Tritanium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Tritanium, 1L))
                .duration(6 * MINUTES).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 9900).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Quantium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Quantium, 1L))
                .duration(3 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 5400)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Bedrockium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Bedrockium, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.MysteriousCrystal, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.MysteriousCrystal, 1L))
                .duration(5 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 7200)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.CosmicNeutronium, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.CosmicNeutronium, 1L))
                .duration(9 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 9900)
                .metadata(ADDITIVE_AMOUNT, 1000).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.InfinityCatalyst, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.InfinityCatalyst, 1L))
                .duration(15 * MINUTES).eut(TierEU.RECIPE_UV).metadata(COIL_HEAT, 10800).metadata(ADDITIVE_AMOUNT, 1000)
                .metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1).addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Infinity, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Infinity, 1L))
                .duration(30 * MINUTES).eut(TierEU.RECIPE_UHV).metadata(COIL_HEAT, 10800)
                .metadata(ADDITIVE_AMOUNT, 1000).metadata(NO_GAS, true).metadata(NO_GAS_CIRCUIT_CONFIG, 1)
                .addTo(BlastFurnaceWithGas);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Kanthal, 1L)).circuit(1)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Kanthal, 1L))
                .circuit(11).itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Kanthal, 1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Sapphire.getDust(3)).circuit(1)
                .itemOutputs(Materials.Aluminiumoxide.getDust(1)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.GreenSapphire.getDust(3)).circuit(1)
                .itemOutputs(Materials.Aluminiumoxide.getDust(1)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Ruby.getDust(3)).circuit(1)
                .itemOutputs(Materials.Aluminiumoxide.getDust(1)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);
        ...
        if (TinkerConstruct.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(getModItem(TinkerConstruct.ID, "materials", 1, 12))
                    .circuit(1)
                    .itemOutputs(Materials.Aluminium.getIngots(1)).duration(2 * MINUTES).eut(TierEU.RECIPE_MV)
                    .metadata(COIL_HEAT, 1600).addTo(blastFurnaceRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(90 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1300).addTo(blastFurnaceRecipes);
